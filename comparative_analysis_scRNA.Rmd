...
ggarrange(plotlist=plots_subtype_hg19, common.legend = T, nrow = 1, legend="right")
...
ggarrange(plotlist=plots_resistance_hg19, common.legend = T, nrow = 1, legend="right")
```
...
ggarrange(plotlist=plots_subtype_mm10, common.legend = T, nrow = 1, legend="right")
...
ggarrange(plotlist=plots_resistance_mm10, common.legend = T, nrow = 1, legend="right")
```
