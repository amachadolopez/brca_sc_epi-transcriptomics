...
# Read all files into a ChromatinAssay within a Seurat Object then merge all of them
import_sc_files <- function(scChip_file){
...
scChIP_hg38  <-lapply(scChIP_hg38_files, import_sc_files)
scChIP_hg38  <- merge(scChIP_hg38[[1]], y=c(scChIP_hg38[[2]], scChIP_hg38[[3]],scChIP_hg38[[4]]))
